...
<?php 
	...
	echo $this->Form->input('state_id', array('label' => array('text' => __('Estado'), 'class' => 'col-sm-2 control-label'), 'class' => 'form-control', 'placeholder' => 'Estado', 'escape' => false,  'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'error' => array( 'attributes' => array('wrap' => 'div', 'class' => 'col-sm-10 col-sm-offset-2 text-danger' ) ) ));
