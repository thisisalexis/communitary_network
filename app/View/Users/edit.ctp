...
<div class="panel panel-default">
	...
	<?php echo $this->Form->end(array('label' => 'Guardar Registro', 'class' => 'btn btn-primary btn-sm', 'div' => 'form-group', 'before' => '<div class="col-sm-10 col-sm-offset-2">', 'after' => '&nbsp;'. $this->Html->link('Cancelar', array('action' => 'index')) . '</div>'  ) ); ?>